...
const Single = () => {
  ...
  const nbPassagers = searchParams.get("nbPassagers");
  ...
  return (
    <div className="single">
      ...
      <div className="singleContainer">
        <div className="top">
          <div className="left">
            <h1 className="title">Flight Trip Details</h1>
            <div className="item">
              ...
              <div className="details">
                ...
                {isAdmin && (
                    <>
                        ...
                        <div className="detailItem">
                        <span className="itemKey">Nb Passangers:</span>
                        <span className="itemValue">{nbPassagers}</span>
                        </div>
                    </>
                )}
                <Link
                  to={`/flights/editTR/${flightNumber}`}
