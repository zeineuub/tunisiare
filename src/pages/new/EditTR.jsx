    ...
    updateEquipage()
      .then((equipage) => {
        let flight = {
          ...
          retard: delay,
          etat: status,
          aeroportDepart: { idAeroport: origin },
        ...
        fetch(`http://192.168.1.8:8090/api/volvoyageurs/${numeroVol}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      value={typeTrip}
                      onChange={(event) => setTypeTrip(event.target.value)}
                    />
                  </Grid>
                </Grid>
